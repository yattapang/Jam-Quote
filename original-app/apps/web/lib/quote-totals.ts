...
// `invoiceBalanceCents(total, paid)` used to live here. It was the wrong sum on
// any contract with a retention clause, and both client-facing surfaces — the PDF
// and its covering email — used it. Use `settlementOf` from core, which asks the
// question that matters: what is payable NOW.

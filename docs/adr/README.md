...
| [0024](0024-acceptance-evidence.md) | A typed name on a phone is not legal evidence (owner, 2026-09-25), so tap-to-accept stays as an operational signal only, the product stops implying otherwise, release 1 gains a signed-copy upload against the issue, and a paid deposit is recorded as corroboration | Accepted |
